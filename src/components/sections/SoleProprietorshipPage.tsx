          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <motion.div custom={4} variants={fadeUp} initial="hidden" animate="show" className="flex flex-wrap gap-x-5 gap-y-2">
                {["3–5 Days Setup", "Starting ₹2,999", "GST + Udyam Included", "100% Online"].map(pt => (
        ...
        <div className="container-custom text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto">
              Get your GST, Udyam certificate and bank account support — all in one affordable package. Starting at ₹2,999.
            </p>
