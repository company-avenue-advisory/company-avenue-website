...
import { faqs } from "@/lib/faqs/Section8CompanyPage";
...
const whyUsPoints = [
  { icon: Award,       label: "CA-Led — 15+ Years in NGO Registrations" },
  ...
  { icon: DollarSign,  label: "Fixed Transparent Pricing — Starting ₹7,999" },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <motion.div custom={4} variants={fadeUp} initial="hidden" animate="show" className="flex flex-wrap gap-x-5 gap-y-2">
                {["15–20 Days Timeline", "12A & 80G Support", "Expert CAs", "Starting ₹7,999"].map(pt => (
                ...
                <div className="bg-white border border-slate-200 rounded-3xl shadow-[0_12px_60px_rgba(15,45,82,0.12)] overflow-hidden">
                  ...
                  <div className="px-5 py-3.5 border-t border-slate-100 flex items-center justify-between bg-slate-50/50">
                    ...
                    <div className="text-right">
                      ...
                      <p className="font-heading font-bold text-dark text-xs">₹7,999</p>
                    </div>
                  </div>
                </div>
          ...
          <div className="hidden xl:block sticky top-24 space-y-4">
            <div className="bg-white border border-slate-100 rounded-2xl p-5 shadow-card">
              ...
              <div className="space-y-2">
                <a href="tel:+919953719111" data-track="call" className="flex items-center justify-center gap-2 w-full py-2.5 bg-primary text-white text-xs font-heading font-semibold rounded-xl hover:bg-[#0a2444] transition-colors">
                ...
                <a href="https://wa.me/919953719111" data-track="whatsapp" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 w-full py-2.5 bg-green-500 text-white text-xs font-heading font-semibold rounded-xl hover:bg-green-600 transition-colors">
            ...
            <div className="bg-slate-50 border border-slate-100 rounded-2xl p-4">
              <div className="grid grid-cols-2 gap-3">
                {[{ v: "15–20", l: "Days Timeline" }, { v: "500+", l: "NGOs Formed" }, { v: "15+", l: "Years CA Practice" }, { v: "₹7,999", l: "Starting Price" }].map(s => (
        ...
        <div className="container-custom text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto">
              Section 8 Company — India&apos;s most credible NGO structure. 12A, 80G, CSR and FCRA support. Starting at ₹7,999.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a href="tel:+919953719111" data-track="call" className="inline-flex items-center gap-2 px-8 py-4 border border-white/30 text-white font-heading font-semibold text-sm rounded-xl hover:bg-white/10 transition-colors">
