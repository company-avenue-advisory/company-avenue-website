      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative rounded-3xl overflow-hidden aspect-[4/5] max-w-md shadow-[0_16px_64px_rgba(15,45,82,0.12)]">
              <Image
            ...
            <motion.div
              ...
              className="absolute -right-6 bottom-10 bg-white rounded-2xl p-4 shadow-card border border-slate-100 max-w-[180px]"
            >
              <p className="font-heading font-bold text-3xl text-primary leading-none">1000+</p>
              <p className="text-muted text-xs mt-1 leading-snug">Businesses trusted us with their compliance</p>
            </motion.div>

            {/* Accent square */}
            <div className="absolute -bottom-4 -left-4 w-24 h-24 bg-primary/8 rounded-2xl -z-10" />
          </motion.div>
              ...
              {features.map((f, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className="group bg-white rounded-2xl p-4 border border-slate-100 hover:border-primary/15 hover:shadow-sm transition-all duration-300"
                  >
                    <div className="w-9 h-9 rounded-xl bg-primary/7 group-hover:bg-primary flex items-center justify-center mb-3 transition-colors duration-300">
                      <Icon size={16} className="text-primary group-hover:text-white transition-colors duration-300" />
                    </div>
                    <p className="font-heading font-semibold text-dark text-sm mb-1 leading-snug">
                      {f.title}
                    </p>
