...
export default function UsNotFound() {
  return (
    <section className="bg-us-ink py-28">
      <div className="mx-auto max-w-md px-5 text-center">
        <p className="font-heading text-[5rem] font-extrabold leading-none tracking-[-0.05em] text-white/10">
          404
        </p>
        <h1 className="mt-4 font-heading text-2xl font-extrabold tracking-[-0.03em] text-white">
          Page not found
        </h1>
        <p className="mt-4 text-[0.9rem] leading-relaxed text-us-chalk">
        ...
        <a
          href="/"
          className="mt-8 inline-flex items-center justify-center gap-2 rounded-full bg-us-lime px-7 py-3.5 font-heading text-[0.95rem] font-bold text-us-ink transition-colors hover:bg-white"
        >
