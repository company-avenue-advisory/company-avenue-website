...
export const metadata: Metadata = {
  ...
  title: "ESIC Registration — Employee State Insurance",
  description:
    "Register under ESI Act 1948 for health insurance and social security. Mandatory for 10+ employees earning ≤₹21,000/month. IP number, challan filing. Starting ₹2,999.",
};
