...
export const metadata: Metadata = {
  ...
  description:
    "Complete ROC annual compliance — AOC-4, MGT-7, board meetings, statutory registers. Avoid MCA penalties up to ₹5 lakh. Expert CA support. Starting ₹4,999/year.",
};
...
export default function ROCComplianceServicePage() {
  return (
    <>
      ...
      <ROCCompliancePage
        pricingSlot={<ServicePricingBlock serviceId="roc-compliance" />}
        calcPill={<ServiceCalcPill serviceId="roc-compliance" />}
      />
    </>
  );
}
