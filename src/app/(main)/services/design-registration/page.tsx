...
export const metadata: Metadata = {
  ...
  description:
    "Protect your product's visual appearance — shape, pattern, and ornamentation — under the Designs Act 2000. Up to 15 years of exclusive protection. Starting ₹9,999 (excl. govt fees).",
};
