...
export const metadata: Metadata = {
  ...
  title: "Virtual CFO Services for Startups & SMEs",
  description:
    "Strategic financial leadership without a full-time CFO. MIS reports, cash flow management, investor readiness, compliance calendar. Starting ₹24,999/month.",
};
