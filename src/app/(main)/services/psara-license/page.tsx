...
export const metadata: Metadata = {
  ...
  title: "PSARA License for Private Security Agencies",
  description:
    "Get your PSARA 2005 license from the State Controlling Authority. Mandatory for all private security agencies in India. Security deposit, police verification, and training compliance. Starting ₹25,500.",
};
