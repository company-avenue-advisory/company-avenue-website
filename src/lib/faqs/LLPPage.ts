...
export const faqs = [
  ...
  { q: "Why choose Company Avenue?", a: "15+ years of CA practice behind every filing, 1000+ businesses registered, dedicated CAs for every client, transparent fixed pricing, 100% digital process and lifetime compliance support — Company Avenue is your end-to-end business compliance partner." },
];
